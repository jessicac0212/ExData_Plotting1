...
# plot the hist of the global active power to the png file in the current working dir
png("plot1.png", width = 480, height = 480)
# set up the 1*1 plot
par(mfrow=c(1,1))
hist(PData$Global_active_power, col="red", main="Global Active Power", 
     xlab = "Global Active Power (kilowatts)")
dev.off()

# remove variables
remove("PData", "read_rows", "end_date070202", "start_row_070201", "start_date070201",
       "stime", "ColNames", "startData", "fileName")
