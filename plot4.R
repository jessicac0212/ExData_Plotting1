...
# plot the plot4.png in the current working dir
...
plot(Time, PData$Voltage, type="l", xlab="datetime", 
     ylab = "Voltage")
# plot the third graph
plot(Time, PData$Sub_metering_1, type="l", col="black",xlab="", ylab = "")
points(Time, PData$Sub_metering_2, type="l", col="red",xlab="", ylab = "")
points(Time, PData$Sub_metering_3, type="l", col="blue",xlab="", ylab = "")
title(xlab="", ylab = "Energy sub metering")
legend("topright", lty=c(1,1,1), col=c("black","red","blue"),
       legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
#plot the fourth graph
plot(Time, PData$Global_reactive_power, type="l", xlab="datetime", 
